...
class Post {
	...
	public function loadPostsFriends_category($data, $limit) {
		...
		$data_query = mysqli_query($this->con, "SELECT * FROM posts WHERE deleted='no' and category_id=$category ORDER BY id DESC");
