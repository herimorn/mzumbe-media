...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/news_intertainment/assets/images/profile_pics';
	//Set File name	
	...
	//Move the file to correct location
		...
		if (!$move) { 
			...
			$imgSrc= "news_intertainment\assets\images\profile_pics/".$file_name; // the image to display in crop area
